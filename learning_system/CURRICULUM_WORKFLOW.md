...
- full chat transcript in live-chat markdown format (for later mining).

Update:
- [learning_system/PROGRESS_LOG.md](PROGRESS_LOG.md)
- topic lesson log under `topics/<root>/<topic>/lessons/`
- topic live chat transcript under `topics/<root>/<topic>/live-chats/YYYY-MM-DD-live-chat.md`
